...
void recoverPoseF( cv::Mat F, cv::InputArray _points1, cv::InputArray _points2, cv::Mat &cameraMatrix,
...
void recoverPoseE( cv::Mat E, cv::InputArray _points1, cv::InputArray _points2, cv::Mat &cameraMatrix,
                  cv::OutputArray _R, cv::OutputArray _t, cv::Mat &mask, std::vector<cv::Point3f> &pts3D)
{
    ...
    for(int i=0; i<X.cols; i++) {
        cv::Point3f pt3d(X.at<float>(0,i)/X.at<float>(3,i), X.at<float>(1,i)/X.at<float>(3,i), X.at<float>(2,i)/X.at<float>(3,i));
